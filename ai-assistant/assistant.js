class MoonAssistant {
    constructor() {
        ...
        this.responses = {
            ...
            zh_cn: {
                welcome: "你好！我是探月助手小嫦。今天有什么可以帮到你的吗？",
                defaultResponse: "我可以在太空探索和嫦娥六号任务方面帮助你。你可以问我：\n1. 嫦娥六号任务详情\n2. 月球探索历史\n3. 月球科学\n4. 学习资源",
                resources: {
                    intro: "以下是一些推荐的学习资源：",
                    list: [
                        "中国国家航天局",
                    ...
                    details: {
                        "中国国家航天局": {
                            description: "中国航天事业的官方网站，提供包括嫦娥探月工程在内的中国航天项目综合信息。",
                            url: "https://www.cnsa.gov.cn/"
                        },
                        "中国载人航天工程": {
                            description: "中国载人航天工程的官方门户网站，提供载人航天任务、科学研究和空间站运营等最新资讯。",
                            url: "https://www.cmse.gov.cn/"
                        },
                        "NASA月球探索指南": {
                            description: "NASA提供的全面月球探索指南，包括任务历史、科学发现和未来计划。",
                            url: "https://moon.nasa.gov/exploration/overview/"
                        },
                        "Space.com月球探索文章": {
                            description: "Space.com提供的最新月球探索新闻和深度文章，涵盖国际任务和发现。",
                            url: "https://www.space.com/topics/moon"
                        },
                        "MIT开放课程 - 太空系统工程": {
                            description: "免费在线课程资料，涵盖航天器设计、任务规划和太空技术基础。",
                            url: "https://ocw.mit.edu/courses/16-851-satellite-engineering-fall-2003/"
                        }
                    }
                },
                knowledgeBase: {
                    "change6": {
                        keywords: ["嫦娥六号", "嫦娥6号", "嫦娥6", "任务", "太空船"],
                        response: "嫦娥六号是中国具有历史意义的月球任务，已于2024年3月5日成功发射。主要特点：\n- 首次尝试从月球背面采集并带回样本\n- 从文昌航天发射场发射\n- 计划收集约2公斤月球样本\n- 将帮助我们了解月球背面的成分\n- 使用鹊桥二号中继卫星进行通信\n- 搭载来自法国、意大利和欧空局的国际载荷"
                    },
                    "farside": {
                        keywords: ["背面", "暗面", "月球背面"],
                        response: "月球背面是永远背对地球的半球。重要知识：\n- 它并不是真的黑暗，接收到的阳光与正面相同\n- 比正面有更多陨石坑，较少月海（深色区域）\n- 是理想的射电天文观测区域\n- 嫦娥四号在2019年首次在那里着陆"
                    },
                    "samples": {
                        keywords: ["样本", "岩石", "物质", "采集"],
                        response: "月球样本采集对理解月球历史至关重要。嫦娥六号任务将：\n- 使用先进的钻探和采样技术\n- 收集约2公斤月球物质\n- 将样本存放在特制容器中\n- 将其带回地球进行分析\n这些样本将帮助我们理解月球的演化和成分。"
                    },
                    "technology": {
                        keywords: ["技术", "仪器", "设备", "工具"],
                        response: "嫦娥六号使用最先进的太空技术，包括：\n- 精确着陆系统\n- 样本采集工具\n- 先进的通信系统\n- 温度控制系统\n- 用于背面通信的中继卫星"
                    },
                    "moonHistory": {
                        keywords: ["历史", "探索历史", "月球历史", "探月历史", "过去任务"],
                        response: "月球探索历史跨越数十年：\n\n1. 早期时代（1950-1960年代）：\n- 1959年：苏联月球2号首次到达月球\n- 1969年：阿波罗11号，人类首次登月\n- 1972年：最后一次阿波罗任务\n\n2. 现代时代（1990年代至今）：\n- 2007年：中国首个月球探测器嫦娥一号\n- 2013年：嫦娥三号，中国首次月面着陆\n- 2019年：嫦娥四号，首次月球背面着陆\n- 2020年：嫦娥五号，月球采样返回\n\n3. 未来展望：\n- 嫦娥六号：首次月球背面采样返回\n- 规划中的国际月球站\n- 商业月球任务"
                    },
                    "spaceTech": {
                        keywords: ["太空技术", "航天", "太空科学", "工程", "太空科技", "航天科技", "科技"],
                        response: "现代太空技术包括几个重要领域：\n\n1. 推进系统：\n- 化学火箭\n- 离子发动机\n- 太阳帆\n\n2. 导航与通信：\n- 深空通信网络\n- 量子通信\n- 卫星定位\n\n3. 生命支持系统：\n- 空气和水循环\n- 辐射防护\n- 温度控制\n\n4. 科学仪器：\n- 光谱仪\n- 相机和传感器\n- 样本分析工具\n\n5. 材料科学：\n- 耐高温材料\n- 轻质复合材料\n- 智能材料"
                    },
                    "lunarScience": {
                        keywords: ["月球科学", "月球地质", "月球形成", "月球成分"],
                        response: "月球科学概述：\n\n1. 月球形成：\n- 巨大碰撞理论\n- 年龄：约45.1亿年\n- 成分与地球地幔相似\n\n2. 月球地质：\n- 月海（暗色玄武岩平原）\n- 月球高地（明亮的陨石坑地形）\n- 撞击坑和盆地\n\n3. 月球内部：\n- 月壳（50-150公里厚）\n- 月幔（部分熔融）\n- 小型铁质核心\n\n4. 当前研究：\n- 极地陨石坑中的水冰\n- 氦-3资源\n- 月震研究\n- 撞击监测"
                    },
                    "spaceMissions": {
                        keywords: ["太空任务", "太空计划", "航天机构", "未来任务"],
                        response: "当前和未来太空任务：\n\n1. 月球任务：\n- NASA阿尔忒弥斯计划\n- 中国嫦娥系列\n- 印度月船系列\n- 私人月球计划\n\n2. 火星任务：\n- NASA火星样本返回\n- 中国天问系列\n- 阿联酋希望号\n\n3. 深空探测：\n- 韦伯望远镜观测\n- ESA柏拉图任务\n- NASA蜻蜓号探测土卫六\n\n4. 空间站：\n- 国际空间站运营\n- 天宫空间站\n- 月球门户空间站"
                    },
                    "astronomicalEvents": {
                        keywords: ["天文", "天象", "观测", "星空", "观星", "行星"],
                        response: "天文现象与观测：\n\n1. 常见天象：\n- 月相和月食\n- 流星雨\n- 行星连珠\n- 季节星座\n\n2. 观测技巧：\n- 最佳观测条件\n- 设备推荐\n- 摄影技术\n\n3. 特殊现象：\n- 太阳活动\n- 彗星和小行星\n- 太空天气\n\n4. 业余天文：\n- 入门指南\n- 设备选择\n- 线上社群"
                    },
                    "spaceCareers": {
                        keywords: ["职业", "工作", "学习", "教育", "培训"],
                        response: "太空行业职业：\n\n1. 技术岗位：\n- 航空航天工程\n- 宇航工程\n- 太空系统设计\n- 任务控制操作\n\n2. 科研岗位：\n- 天体物理学\n- 行星科学\n- 太空医学\n- 太空化学\n\n3. 支持岗位：\n- 项目管理\n- 太空法律\n- 太空经济\n- 公共教育\n\n4. 教育路径：\n- 推荐学位\n- 实习机会\n- 研究项目\n- 航天机构招聘"
                    },
                    "moonExploration": {
                        keywords: ["探索", "月球基地", "月球殖民", "月球定居"],
                ...
                interactiveFeatures: {
                    calculator: {
                        description: "我可以帮助进行太空相关计算。你可以询问：\n- 轨道周期\n- 逃逸速度\n- 任务时长\n- 距离计算",
                        examples: [
                            "计算地月距离",
                            "环绕月球需要多久？",
                            "月球的逃逸速度是多少？"
